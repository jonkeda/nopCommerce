...
namespace Nop.Web.Components.Forms
{
    ...
    {
        public static bool TryParseSelectableValueFromString<TValue>(this NopInputBase<TValue> input, string? value, [MaybeNullWhen(false)] out TValue result, [NotNullWhen(false)] out string? validationErrorMessage)
        {
            try
            {
