...
{
    /// <summary>
    /// Describes context for an <see cref="NopInputRadio{TValue}"/> component.
    /// </summary>
    internal class NopInputRadioContext
    {
        private readonly NopInputRadioContext? _parentContext;
        ...
        /// <summary>
        /// Instantiates a new <see cref="NopInputRadioContext" />.
        /// </summary>
        /// <param name="parentContext">The parent <see cref="NopInputRadioContext" />.</param>
        ...
        public NopInputRadioContext(
            NopInputRadioContext? parentContext,
            string groupName,
            object? currentValue,
            string fieldClass,
        ...
        /// <summary>
        /// Finds an <see cref="NopInputRadioContext"/> in the context's ancestors with the matching <paramref name="groupName"/>.
        /// </summary>
        /// <param name="groupName">The group name of the ancestor <see cref="NopInputRadioContext"/>.</param>
        /// <returns>The <see cref="NopInputRadioContext"/>, or <c>null</c> if none was found.</returns>
        public NopInputRadioContext? FindContextInAncestors(string groupName)
