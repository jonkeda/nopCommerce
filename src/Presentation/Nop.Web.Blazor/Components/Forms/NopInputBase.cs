...
namespace Nop.Web.Components.Forms
{
    ...
    /// </summary>
    public abstract class NopInputBase<TValue> : ComponentBase, IDisposable
    {
        ...
        /// <summary>
        /// Constructs an instance of <see cref="NopInputBase{TValue}"/>.
        /// </summary>
        protected NopInputBase()
        {
        ...
        protected string CssClass
        {
            get
            {
                ...
                {
                    return $"{@class} {FieldClass} {CssClasses}";
                }

                return $"{FieldClass} {CssClasses}"; // Never null or empty
            }
        }

        public string CssClasses { get; set; } = "col-sm-7";
