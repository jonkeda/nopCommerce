...
namespace Nop.Web.Components.Forms
{
    ...
    /// </summary>
    public class NopInputRadio<TValue> : ComponentBase
    {
        /// <summary>
        /// Gets context for this <see cref="InputRadio{TValue}"/>.
        /// </summary>
        internal NopInputRadioContext? Context { get; private set; }
        ...
        protected override void OnParametersSet()
        {
            ...
            if (Context == null)
            {
                throw new InvalidOperationException($"{GetType()} must have an ancestor {typeof(NopInputRadioGroup<TValue>)} " +
